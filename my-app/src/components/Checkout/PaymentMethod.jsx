        ...
        <div className="paymentMethod">
            ...
            <div className="paymentCard">
                ...
                <div className="paymentFirst">
                    ...
                    <div className="paymentFirstLeft">

                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10.8105 20.8701C16.3334 20.8701 20.8105 16.3929 20.8105 10.8701C20.8105 5.34721 16.3334 0.870056 10.8105 0.870056C5.2877 0.870056 0.810547 5.34721 0.810547 10.8701C0.810547 16.3929 5.2877 20.8701 10.8105 20.8701Z" fill="#6A983C" stroke="#6A983C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="bevel" />
                            <path d="M11 16.0001C13.7614 16.0001 16 13.7615 16 11.0001C16 8.23864 13.7614 6.00006 11 6.00006C8.23858 6.00006 6 8.23864 6 11.0001C6 13.7615 8.23858 16.0001 11 16.0001Z" fill="white" />
                        </svg>
                    ...
                    <div className="paymentFirstRight">
                        <svg width="94" height="20" viewBox="0 0 94 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_24480:38603)">
                                <g clip-path="url(#clip1_24480:38603)">
                            ...
                            <defs>
                                <clipPath id="clip0_24480:38603">
                                    <rect width="94" height="20" fill="white" />
                                </clipPath>
                                <clipPath id="clip1_24480:38603">
                ...
                <div className="paymentSecond">
                    <label htmlFor="">Card Number <br />
                        <input type="number" placeholder="Card number" name="" id="" />
                    </label>
                </div>
                ...
                <div className="paymentThird">
                    ...
                    <div className="cardHolder">
                        <label htmlFor="">Card Holder <br />
                            <input type="text" placeholder="Card Holder" name="" id="" />
                        </label>
                    </div>

                    <div className="expDate">
                        <label htmlFor="">Expiration Date <br />
                            <input type="date" />
                        </label>
                    </div>

                    <div className="cvc">
                        <label htmlFor="">CVC <br />
                            <input type="number" placeholder="CVC" name="" id="" />
                        </label>
                    </div>
