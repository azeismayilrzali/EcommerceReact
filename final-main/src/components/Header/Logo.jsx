...
function Logo(props) {
    ...
    return (
        <div className="mainHeaderLeft">
            ...
            <Link to="/">
                <svg width="177" height="18" viewBox="0 0 177 18" fill="white" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* <div className="flexTouch" ref={touchRef}>
                    <a aria-label="Get in Touch " className="rolling-text getInTouch" >
                        <div className="spans">
                            <svg className="block" width="177" height="18" viewBox="0 0 177 18" fill="white" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="block" >
                                <span className="letter" style={{color:'#1a237e'}}>G</span>
                                <span className="letter" style={{color:'#1a237e'}}>e</span>
                                <span className="letter" style={{color:'#1a237e'}}>t</span>
                                <span className="letter" style={{color:'#1a237e'}}>&nbsp;</span>
                                <span className="letter" style={{color:'#1a237e'}}>i</span>
                                <span className="letter" style={{color:'#1a237e'}}>n</span>
                                <span className="letter">&nbsp;</span>
                                <span className="letter" style={{color:'#1a237e'}}>T</span>
                                <span className="letter" style={{color:'#1a237e'}}>o</span>
                                <span className="letter" style={{color:'#1a237e'}}>u</span>
                                <span className="letter"style={{color:'#1a237e'}}>c</span>
                                <span className="letter"style={{color:'#1a237e'}}>h</span>
